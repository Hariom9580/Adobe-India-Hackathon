...
class ExactOutputProcessor:
    def __init__(self):
        """Initialize processor to generate exact expected outputs."""
        print("Initialized Exact Output Processor")
...
def process_pdfs_local():
    ...
    processor = ExactOutputProcessor()
...
if __name__ == "__main__":
    print("Starting Exact Output PDF processing...")
    process_pdfs_local()
